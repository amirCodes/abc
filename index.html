...
<html lang="en">
<!-- Basic 
https://stackoverflow.com/questions/40430462/multi-language-page-with-javascript-or-jquery/47612798#47612798
-->
...
<head>
    ...
    <link rel="icon" href="./images/favicon2.png" type="image/gif" sizes="16x16">
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <header class="top-header">
        <nav class="navbar header-nav nav bar-expand-lg" style="margin-bottom: 0px;">
            <ul class="exo-menu">
                <li>
 ...
 -->
    ...
    <!-- <div class="section layout_padding theme_bg_vision">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 white_fonts">
                    <h3 class="small_heading">OUR VISION </h3>
    ...
    <footer class="footer-box">
        <div class="container">
            <div class="row">
                <!-- <div class="col-lg-12">
          <div class="logo">
              <a href="index.html"><img src="images/footer_logo.png" style="height: 200px;"alt="#" /></a>
          </div>
      </div> -->
                ...
                <div class=" col-md-12  white_fonts">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="full white_fonts text_align_left">
                                <p> <b style="color:#eb8224;">Malaysia</b><br /> Suite 3.02B,Level 3, South Wing, Menara OBYU ,No. 4 Jalan PJU 8/8A,<br/> Damansara Perdana, 47820,Petaling Jaya,<br/> Selangor D.E,Malaysi
                                    <br />
                                    <p>Email:info@infosysgateway.com.my <br /> <br/>Phone No.: +603-7732 9900</p>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6 ">
    ...
    <div class="footer_bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="crp">© 2021 Infosys Gateway Sdn Bhd . All Rights Reserved.</p>
